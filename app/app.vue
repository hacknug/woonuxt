...
<style lang="postcss">
html, body { @apply bg-gray-100 text-gray-900 font-[Cardo] scroll-smooth; }
pre { @apply rounded bg-gray-800 my-8 text-xs text-white p-4 whitespace-pre-wrap overflow-auto; }
