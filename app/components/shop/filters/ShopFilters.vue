...
<template>
  <aside id="filters" class="top-24 sticky mt-8 mb-16">
    <div class="relative z-30 grid divide-y *:py-4">
      <ShopOrderBy class="flex w-full md:hidden" />

      <ShopFiltersPrice />
      <ShopFiltersCategory v-if="!hideCategories" :terms="productCategoryTerms" :showCount="true" />
      ...
      <ShopFiltersSale />
      <ShopFiltersRating v-if="storeSettings.showReviews" />

      <ShopFiltersReset v-if="isFiltersActive" class="mt-auto" />
    </div>
  </aside>
